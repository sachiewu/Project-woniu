...
//商品数据渲染
!function ($) {
    var container = $('.prop-rqdp-container');
    $.ajax({
        type: 'get',
        dataType: 'json',
    ...
    //轮播图
    var circle = $('.prop-slide-page a');
    var picli = $('.prop-slide li');
    var left = $('.prop-slide-btn-left');
    var right = $('.prop-slide-btn-right');
    var num = null;
    var timer = null;
    //圈圈加类
    ...
    var ali = $('.prop-selectBar-slide li');
    var item = $('.prop-yxdj-products');
